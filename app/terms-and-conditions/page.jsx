    ...
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 mb-8">
        ...
        <li>
          ...
          Agreement) refers to P. A. Isoh Legal Consultants, Kingfem Plaza, Mabushi, FCT,
          Abuja.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to P. A. Isoh Legal Consultants, accessible from
          <a className="underline ml-1" href="https://www.isohlegal.com" target="_blank" rel="noopener noreferrer">https://www.isohlegal.com</a>
        </li>
        <li>
      ...
      <h2 className="mb-3">Acknowledgment</h2>
      <p className="mb-6">
      ...
      <p className="mb-8">
        ...
        services. We strongly advise You to read the terms and conditions and privacy policies of any third-
      ...
      <p className="mb-8">
        ...
        USD if You haven't purchased anything through the Service. To the maximum extent permitted by
        applicable law, in no event shall the Company or its suppliers be liable for any special, incidental,
        ...
        Terms), even if the Company or any supplier has been advised of the possibility of such damages and
        even if the remedy fails of its essential purpose. Some states do not allow the exclusion of implied
        warranties or limitation of liability for incidental or consequential damages, which means that some of
        the above limitations may not apply. In these states, each party's liability will be limited to the greatest
        extent permitted by law.
      </p>

      <h2 className="mb-3">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      <p className="mb-8">
        ...
        reliability standards or be error free or that any errors or defects can or will be corrected. Without
        limiting the foregoing, neither the Company nor any of the company's provider makes any representation
        ...
        the Service; or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf of the Company
        are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components. Some
        jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory
      ...
      <h2 className="mb-3">Disputes Resolution</h2>
      <p className="mb-8">
      ...
      <h2 className="mb-3">For European Union (EU) Users</h2>
      <p className="mb-8">
      ...
      <h2 className="mb-3">United States Legal Compliance</h2>
      <p className="mb-8">
      ...
      <h2 className="mb-3">Severability and Waiver</h2>
      ...
      <h2 className="mb-3">Translation Interpretation</h2>
      <p className="mb-8">
      ...
      <h2 className="mb-3">Changes to These Terms and Conditions</h2>
      <p className="mb-8">
        ...
        at Our sole discretion. By continuing to access or use Our Service after those revisions become
        effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part,
